...
VALUES ('UNIT_ANIMAL_NILE_CROCODILE', 'CLASS_LAND_ANIMAL'),
        ...
        ('UNIT_ANIMAL_MANTA', 'CLASS_LAND_ANIMAL'),
        ('UNIT_ANIMAL_ORCA', 'CLASS_LAND_ANIMAL'),
        ('UNIT_ANIMAL_TIGERSHARK', 'CLASS_LAND_ANIMAL'),
        ('UNIT_ANIMAL_BULLSHARK', 'CLASS_LAND_ANIMAL'),
        ('UNIT_ANIMAL_HAMMERHEAD', 'CLASS_LAND_ANIMAL'),
        ('UNIT_ANIMAL_WHITESHARK', 'CLASS_LAND_ANIMAL'),
        ('UNIT_ANIMAL_KRAKEN', 'CLASS_LAND_ANIMAL'),		
        ('UNIT_ANIMAL_HUMPBACK_WHALE', 'CLASS_LAND_ANIMAL');